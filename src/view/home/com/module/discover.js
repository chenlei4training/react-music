            ...
            <div className='wrap'>
                        ...
                        <div className="item">
                            <div className="cover">
                                ...
                                <div className="bottom">
                                    <a title="播放" href="javascript:;" data-res-type="13" data-res-id="924680166" data-res-action="play"></a>
                                    <span className="icon-headset">&nbsp;</span>
                                    <span className="nb">59431万</span>
                                </div>
                            </div>
                            <p className="dec">
                                <a href="#">
                        ...
                        <div className="item">
                            <div className="cover">
                                ...
                                <div className="bottom">
                                    ...
                                    <a className="icon-play" title="播放" href="javascript:;" data-res-type="13" data-res-id="924680166" data-res-action="play"></a>
                                </div>
                            </div>
                            <p className="dec">
                                <a href="#">
                ...
                <div className="right-panel">
                    ...
                    <div className="my-info">
                        <p className="note">登录云音乐，可以享受无限收藏的乐趣，并且无限同步到手机</p>
                        <button>用户登录</button>
                    </div>
                    ...
                    <div className='button'><i>成为音乐人</i></div>
                    ...
                    <div className='dj'>
                        ...
                        <ul>
                            <li>
                                ...
                                <div className="info">
                                    <p>
                                        <a href="#" className="">陈立</a> <sup className=""></sup>
                                    </p>
                                </div>
                            </li>
                        </ul>
